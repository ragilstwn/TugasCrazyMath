<?php
	...
	if (isset($_POST['submit1'])){
		...
		setcookie('gambar', $namabaru, time()+3600*24*7);
...
<body>
	...
	<?php
		...
		if ($_SESSION['lives'] == 0){
			...
			$query = "INSERT INTO scores (username, score, playtime, gambar) VALUES ('".$_COOKIE['username']."', '".$_SESSION['score']."', '".date('Y-m-d H:i:s')."','".$_COOKIE['gambar']."')";
